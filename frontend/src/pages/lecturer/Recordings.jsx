...
const LecturerRecordings = () => {
  ...
  const createRecording = async (e) => {
    ...
    if (!moduleId || !title || !videoUrl) {
      alert("Please select module, enter title, and video URL");
      return;
    }
    ...
    try {
      ...
      await fetchRecordings(moduleId);
    } catch (err) {
      alert(err?.response?.data?.message || "Failed to create recording");
    } finally {
      setSubmitting(false);
    }
  };
            ...
            <div style={styles.header}>
              <div>
                ...
                <p style={styles.subtitle}>
                  Manage lecture recordings by module
                </p>
              </div>
          ...
          <div style={styles.selectorCard}>
            <div style={styles.sectionTop}>
              ...
              <p style={styles.sectionSubtitle}>
                Choose a module to manage lecture recordings
              </p>
            </div>
          ...
          {moduleId ? (
            <>
              <div style={styles.formCard}>
                <div style={styles.sectionTop}>
                  <h2 style={styles.sectionTitle}>Add Recording</h2>
                  <p style={styles.sectionSubtitle}>
                    Add a new video recording for the selected module
                  </p>
                </div>

                <form onSubmit={createRecording} style={styles.form}>
                  <input
                ...
                <div style={styles.tableWrapper}>
                  <div style={styles.tableHeader}>
                    ...
                    <p style={styles.tableSubtitle}>
                      View all uploaded recordings for the selected module
                    </p>
                  </div>
                  ...
                  <div style={styles.tableResponsive}>
                    ...
                    {recordings.length === 0 && (
                      <div style={styles.emptyState}>No recordings found.</div>
                    )}
                  </div>
                </div>
              )}
            ...
            !loadingModules && (
              <div style={styles.emptySelectionCard}>
                Please select a module to view and manage recordings.
              </div>
            )
          )}
        </div>
...
export default LecturerRecordings;