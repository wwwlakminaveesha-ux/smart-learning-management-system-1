        ...
        <div style={styles.content}>
          <div style={styles.headerCard}>
            <div style={styles.header}>
              <div>
                <div style={styles.badge}>Analytics & Reporting</div>
                <h1 style={styles.title}>Full System Reports</h1>
                <p style={styles.subtitle}>
                  Detailed LMS reporting, academic analytics, and summary insights
                </p>
              </div>
          ...
          {loading ? (
            ...
            <>
                ...
                <div style={styles.sectionHeader}>
                  <div>
                    ...
                    <p style={styles.sectionSubtitle}>
                      Overview of registered and active users in the LMS
                    </p>
                  </div>
                </div>
              ...
              <section style={styles.sectionCard}>
                <div style={styles.sectionHeader}>
                  <div>
                    <h2 style={styles.sectionTitle}>Academic Statistics</h2>
                    <p style={styles.sectionSubtitle}>
                      Departments, modules, assignments, and quiz activity
                    </p>
                  </div>
                </div>
              ...
              <section style={styles.sectionCard}>
                <div style={styles.sectionHeader}>
                  <div>
                    <h2 style={styles.sectionTitle}>Content Statistics</h2>
                    <p style={styles.sectionSubtitle}>
                      Learning materials, recordings, and published results
                    </p>
                  </div>
                </div>
              ...
              <section style={styles.sectionCard}>
                <div style={styles.sectionHeader}>
                  <div>
                    ...
                    <p style={styles.sectionSubtitle}>
                      Quick summary of the most important LMS metrics
                    </p>
                  </div>
                </div>
                ...
                <div style={styles.summaryBox}>
                  <div style={styles.summaryRow}>
                    <span style={styles.summaryLabel}>System Users</span>
                  ...
                  <div style={styles.summaryRow}>
                    <span style={styles.summaryLabel}>Active Academic Modules</span>
                    <span style={styles.summaryValue}>
                      {stats?.academics?.totalModules ?? 0}
                    </span>
                  </div>

                  <div style={styles.summaryRow}>
                    <span style={styles.summaryLabel}>Uploaded Learning Materials</span>
                    <span style={styles.summaryValue}>
                      {stats?.content?.totalMaterials ?? 0}
                    </span>
                  </div>

                  <div style={styles.summaryRow}>
                    <span style={styles.summaryLabel}>Lecture Recordings</span>
                    <span style={styles.summaryValue}>
                      {stats?.content?.totalRecordings ?? 0}
                    </span>
                  </div>

                  <div style={styles.summaryRow}>
                    <span style={styles.summaryLabel}>Published Results</span>
                    <span style={styles.summaryValue}>
                  ...
                  <div style={styles.summaryRow}>
                    <span style={styles.summaryLabel}>Assignment Submissions</span>
                    <span style={styles.summaryValue}>
                      {stats?.academics?.totalSubmissions ?? 0}
                    </span>
                  </div>

                  <div style={{ ...styles.summaryRow, borderBottom: "none" }}>
                    <span style={styles.summaryLabel}>Online Quizzes</span>
                    <span style={styles.summaryValue}>
                      {stats?.academics?.totalQuizzes ?? 0}
                    </span>
                  </div>
                </div>
              </section>
...
const styles = {
  ...
  summaryBox: {
    ...
    boxShadow: "0 12px 30px rgba(22, 101, 52, 0.06)",
  },
