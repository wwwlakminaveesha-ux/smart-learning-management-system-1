...
const StudentMaterials = () => {
  ...
  const fetchMaterials = async (selectedModuleId) => {
    if (!selectedModuleId) {
      setMaterials([]);
      return;
    }
    ...
    try {
      ...
      const res = await api.get(`/materials/module/${selectedModuleId}`);
            ...
            <div style={styles.header}>
              <div>
                ...
                <p style={styles.subtitle}>
                  View learning materials for your enrolled modules
                </p>
              </div>
          ...
          <div style={styles.selectorCard}>
            <div style={styles.sectionTop}>
              ...
              <p style={styles.sectionSubtitle}>
                Choose a module to view available learning materials
              </p>
            </div>
              ...
              <div style={styles.tableWrapper}>
                <div style={styles.tableHeader}>
                  ...
                  <p style={styles.tableSubtitle}>
                    Browse and open learning materials for the selected module
                  </p>
                </div>
                  ...
                  <table style={styles.table}>
                    ...
                    <tbody>
                      {materials.map((material) => (
                        <tr key={material._id} style={styles.tr}>
                          <td style={styles.td}>{material.title}</td>
                          <td style={styles.td}>{material.description || "-"}</td>
                          <td style={styles.td}>
